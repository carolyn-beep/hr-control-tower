-- Insert sample signal data for demonstration with correct level values
...
-- Insert sample signals with valid levels and recent timestamps
INSERT INTO signal (person_id, level, reason, ts, score_delta) VALUES 
  ...
  ('person_003', 'warning', 'Minor performance dip detected', NOW() - INTERVAL '2 days', -0.5),
  ...
  ('person_004', 'warning', 'Attendance pattern changes detected', NOW() - INTERVAL '12 hours', -0.8),
  ('person_001', 'info', 'Minor workflow adjustment suggested', NOW() - INTERVAL '4 days', -0.2),
  ('person_002', 'warning', 'Communication frequency decreased', NOW() - INTERVAL '10 hours', -0.7);
